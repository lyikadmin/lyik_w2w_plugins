...
def stamp_pdf(
    ...
    rect_coords=(200, 700, 370, 800) # (x0, y0, x1, y1) in points from top-left end
) -> bytes:
    """
    ...
    try:
        ...
        page.insert_text((rect.x0, rect.y0 + 30), f"{signing_text}", fontsize=8, color=(0, 0, 0))
        ...
        return output_stream.read()
         ...
         raise Exception(f'Error adding signature stamp to pdf: {e}')


async def digitally_sign_pdf(
    pdf_bytes: bytes,
    ...
    try:
        ...
        signed_stream = await signers.async_sign_pdf(
            writer,
        ...
        return signed_stream.read()
         ...
         raise Exception(f'Error digitally signing the doc: {e}') 
