...
#   filename:  aof_schema.json
#   timestamp: 2025-04-16T07:30:47+00:00
...
class RootApplicationDetailsClientContactDetails(BaseModel):
    ...
    client_mobile: Optional[str] = Field(None, title="Mobile")
...
class RootApplicationDetailsGeneralApplicationDetails(BaseModel):
    ...
    application_type: Optional[APPLICATIONTYPE] = Field(
        None, description="Select Option", title="Type of Application"
    )
    residential_status: Optional[RESIDENCESTATUSRIONLY] = Field(
...
class RootBankVerificationBankDetails(BaseModel):
    ...
    ifsc_code: Optional[constr(pattern=r"[A-Z]{4}\d{7}")] = Field(
    ...
    account_type: Optional[BANKACCOUNTTYPE] = Field(
        None, description="Bank Account Type", title="Account Type"
    )
    account_holder_name_pan: Optional[str] = Field(
        None, description="Name as per PAN", title="Name as per PAN"
    )
    account_holder_name_id: Optional[str] = Field(
    ...
    account_mobile_number: Optional[str] = Field(None, title="Mobile Number")
...
class RootBankVerificationCancelledCheque(BaseModel):
    ...
    cancelled_cheque_image: Optional[Union[str, Dict[str, Any]]] = Field(
        None,
...
class RootDpInformationStandingInfoFromClient(BaseModel):
    ...
    first_holder_sms_alert: Optional[SMSALERTOPTION] = Field(
        "FIRST_HOLDER", title="SMS Alert Facility"
    )
    account_statement_requirement: Optional[FREQUENCY] = Field(
        "MONTHLY", title="Account Statement Requirement"
    )
    ...
    aadhaar_pan_seed_status: Optional[PANAADHAARSEED] = Field(
        "YES", title="PAN is seeded with Aadhaar"
    )
...
class RootKycHoldersKycHolderDeclarationsIncomeInfo(BaseModel):
    ...
    date: Optional[str] = Field(None, description="Enter Date", title="Date (Networth)")
...
class RootKycHoldersKycHolderIdentityAddressVerificationCorrespondenceAddress(
    ...
    state: Optional[str] = Field(None, description="State", title="State")
    pin: Optional[str] = Field(None, description="PIN", title="PIN")
...
class RootKycHoldersKycHolderIdentityAddressVerificationIdentityAddressInfo(BaseModel):
    ...
    uid: Optional[str] = Field(None, description="ID Number", title="ID Number")
    id_proof_expiry: Optional[date] = Field(
        None, description="Expiry date for ID Proof", title="ID Proof Expiry Date"
    )
    gender: Optional[GENDER] = Field(None, description="Gender", title="Gender")
    type_of_address: Optional[ADDRESSTYPE] = Field(
        None, description="Select Option", title="Type of Address"
    )
    full_address: Optional[str] = Field(
...
class RootKycHoldersKycHolderIdentityAddressVerificationOtherInfo(BaseModel):
    ...
    country_of_birth: Optional[COUNTRYINDONLY] = Field(
        "India", description="Enter Country of Birth", title="Country of Birth"
    )
    residential_status: Optional[RESIDENCESTATUSRIONLY] = Field(
        None, description="Select Option", title="Residential Status of Client"
    )
...
class RootKycHoldersKycHolderIdentityAddressVerificationOvdCorr(BaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    ovd_type: Optional[OVDTYPE] = Field(
...
class RootKycHoldersKycHolderMobileEmailVerificationEmailVerification(BaseModel):
    ...
    dependency_relationship_email: Optional[RELATIONSHIP] = Field(
...
class RootKycHoldersKycHolderMobileEmailVerificationMobileVerification(BaseModel):
    ...
    dependency_relationship_mobile: Optional[RELATIONSHIP] = Field(
        None, description="Select Option", title="Dependency Relationship"
    )
...
class RootKycHoldersKycHolderSignatureValidationUploadImages(BaseModel):
    ...
    wet_signature_image: Optional[Union[str, Dict[str, Any]]] = Field(
        None, description="Upload an image", title="Image of Wet Signature"
    )
    proof_of_signature: Optional[Union[str, Dict[str, Any]]] = Field(
...
class RootNominationDetailsGeneral(BaseModel):
    ...
    client_nominee_appointment_status: Optional[OPTION] = Field(
...
class RootNominationDetailsNomineesNomineeNomineeData(BaseModel):
    ...
    nominee_type_of_id: Optional[OVDTYPE] = Field(
...
class RootOnboarding(BaseModel):
    ...
    type_of_client: Optional[CLIENTTYPEINDONLY] = Field(
...
class RootTncDeclaration(BaseModel):
    ...
    sms_alert: Optional[SMSALERT] = Field(None, title="")
    policy: Optional[POLICY] = Field(None, title="")
    processing_time: Optional[PROCESSINGTIME] = Field(None, title="")
...
class RootTradingInformationCheckPanForTradingAccount(BaseModel):
    ...
    trading_account_pan_number: Optional[str] = Field(
        "$.kyc_holders[0].kyc_holder.pan_verification.pan_details.pan_number",
...
class RootTradingInformationTradingAccountInformation(BaseModel):
    ...
    contract_format_2: Optional[CONTRACTFORMAT2] = Field("ELECTRONIC_FORM", title="")
    proof_of_income: Optional[Union[str, Dict[str, Any]]] = Field(
        None, description="Upload the document", title="Upload proof of income"
    )
    type_of_document: Optional[PROOFOFINCOME] = Field(
        None, title="Income Proof Document"
    )
...
class RootApplicationDetails(BaseModel):
    ...
    kyc_digilocker: Optional[OPTION] = Field(
...
class RootKycHoldersKycHolderIdentityAddressVerification(BaseModel):
    ...
    ovd_corr: Optional[RootKycHoldersKycHolderIdentityAddressVerificationOvdCorr] = (
        Field(None, title="Upload OVD for Correspondence Address")
    )
